...
$hx_exports.blueprint = $hx_exports.blueprint || {};
$hx_exports.blueprint.editor = $hx_exports.blueprint.editor || {};
...
editor.JsonReader = $hx_exports.blueprint.editor.JsonReader = function() {
};
editor.JsonReader.__name__ = true;
editor.JsonReader.prototype = {
	read: function(input) {
		var data = input;
		var result = new editor.Module();
		result.setName(data.name);
		var _g = 0;
		var _g1 = Reflect.fields(data.nodes);
		while(_g < _g1.length) {
			var nodeId = _g1[_g];
			++_g;
